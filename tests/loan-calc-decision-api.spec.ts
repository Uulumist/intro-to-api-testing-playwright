...
test.describe('tests for POST/loan-calc/decision', () => {
  ...
  test('Send call with income boundary value and loanPeriod: 3, should receive riskLevel: High risk', async ({ request }) => {
  ...
  test('Send call with dept boundary value and loanPeriod: 9, should receive riskLevel: Medium risk', async ({ request }) => {
  ...
  test('Send call with age boundary value and loanPeriod: 12, should receive riskLevel: Low risk', async ({ request }) => {
  ...
  test('Send call with incorrect dept boundary value, should receive code 400', async ({ request }) => {
  ...
  test('Send call with incorrect dept boundary value, should receive code 200', async ({ request }) => {
    const requestBody = {
      "income": 73,
      "debt": -1,
      "age": 82,
